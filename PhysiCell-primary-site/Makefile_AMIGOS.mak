...
ALL_OBJECTS_3D := $(PhysiCell_OBJECTS) $(PhysiCell_custom_module_OBJECTS_3D)
...
primary_site.o: ./custom_modules/primary_site.cpp 
	$(COMPILE_COMMAND) -c ./custom_modules/primary_site.cpp
