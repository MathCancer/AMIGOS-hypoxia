...
#import matplotlib
#matplotlib.use('Agg')  # may need to use on remote machine
import sys
...
# rwh: if you want absolute values, use "vmin", "vmax":
voxel_plot0 = ax0.scatter(x, y, marker='h', s=marker_size, c=o2, cmap=cm, vmin=0.0, vmax=1.00)
...
voxel_plot1 = ax1.scatter(x, y, marker='h', s=marker_size, c=angio, cmap=cm, vmin=0.0, vmax=0.01)
...
# rwh: if you want absolute values, set the limits on the axes:
ax4.set_xlim([0., 0.4])
ax4.set_ylim([0, 175])
...
#-----------------
plt.suptitle("This plot totally explains John's project", y=0.94, fontsize=16)
#fig.tight_layout()
plt.subplots_adjust(left=0.05, right=0.98, bottom=0.05, top=0.85, wspace=0.3,hspace=0.2)
