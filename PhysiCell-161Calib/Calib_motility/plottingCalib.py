...
ax1.set_xlabel('Bias',fontsize='large')
...
ax2.set_xlabel('Speed', fontsize='large')
...
ax3.set_xlabel('Bias', fontsize='large')
...
ax4.set_xlabel('Speed', fontsize='large')
...
ax1.set_ylabel('Displacement ($\mu m$)',fontsize='large')
ax1.legend([(p3[0], p2[0]),p1 ], ['Model','Data'], bbox_to_anchor=(0., 1.02, 1., .102), loc='center', ncol=3,fontsize='large')
print(p1)
ax1.tick_params(labelsize='large')
...
ax2.set_xlabel('Time (min)',fontsize='large')
ax2.set_ylabel('Displacement ($\mu m$)',fontsize='large')
ax2.legend([(p3[0], p2[0]),p1 ], ['Model','Data'], bbox_to_anchor=(0., 1.02, 1., .102), loc='center', ncol=3,fontsize='large')
ax2.tick_params(labelsize='large')
print("Distance GFP: "+str(np.linalg.norm(GFPDisplacement-mapG)))

plt.subplots_adjust(left=0.17,right=0.95,bottom=0.08,top=0.95,hspace=0.40)
plt.show()